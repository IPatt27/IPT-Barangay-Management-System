        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 d-flex align-items-center gap-4 mb-2">
                    <img id="photoPreview"
                         src="https://ui-avatars.com/api/?name=New+Official&background=2d6a4f&color=fff&size=128"
                         style="width:80px; height:80px; border-radius:50%; object-fit:cover; border:2px solid #e5e5e5;">
                    <div>
                        <label class="form-label fw-semibold mb-1">Photo <span class="text-muted small">(Optional)</span></label>
                        ...
                        <div class="text-muted small mt-1">JPG or PNG, max 2MB</div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="address" class="form-control"
                           placeholder="e.g. Purok 2, New Era, Quezon City"
                           value="{{ old('address') }}">
                </div>
