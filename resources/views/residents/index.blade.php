...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 style="font-size:28px; font-weight:700; color:#1a1a1a;">Resident Management</h2>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('residents.add') }}" class="btn btn-success" id="addBtn">
                + Add New Resident
            </a>
            @endhasanyrole
        </div>
    ...
    <div id="trashedBanner" class="alert alert-warning d-none" role="alert">
        ...
        You are viewing <strong>trashed residents</strong>. These have been soft-deleted and are
